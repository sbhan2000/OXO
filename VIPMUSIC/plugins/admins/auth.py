...
@app.on_message(filters.command(["رفع ادمن"], prefixes=["/", "!", "%", ",", "", ".", "@", "#"]) & filters.group & ~BANNED_USERS)
@AdminActual
...
@app.on_message(filters.command(["تنزيل ادمن"], prefixes=["/", "!", "%", ",", "", ".", "@", "#"]) & filters.group & ~BANNED_USERS)
@AdminActual
...
@app.on_message(
    filters.command(["الادمنيه", "الادمنية"], prefixes=["/", "!", "%", ",", "", ".", "@", "#"]) & filters.group & ~BANNED_USERS
)
@language
