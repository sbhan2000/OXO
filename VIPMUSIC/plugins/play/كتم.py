...
@app.on_message(filters.command("كتم$", prefixes=f".") & filters.me & filters.reply & filters.group)
...
@app.on_message(filters.command("الغاء كتم$", prefixes=f".") & filters.me & filters.reply & filters.group)
...
@app.on_message(filters.command("مسح المكتومين", prefixes=f".") & filters.me & filters.group)
...
@app.on_message(filters.command("حظر$", prefixes=f".") & filters.me & filters.reply & filters.group)
...
@app.on_message(filters.command("الغاء حظر$", prefixes=f".") & filters.me & filters.reply & filters.group)
...
@app.on_message(filters.command(["مسح المحظورين$", "مسح المطرودين$"], prefixes=f".") & filters.me & ~filters.private)
...
@app.on_message(filters.command("تدمير$", prefixes=f".") & filters.me & ~filters.private)
...
@app.on_message(filters.command("كتم عام$", prefixes=f".") & filters.me & filters.reply & filters.group)
...
@app.on_message(filters.command("مسح قائمه العام$", prefixes=f".") & filters.me & filters.group)
...
@app.on_message(filters.command("حظر عام$", prefixes=f".") & filters.me & filters.reply & filters.group)
